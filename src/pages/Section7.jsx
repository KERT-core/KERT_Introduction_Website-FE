      ...
      <ProfilesWrapper>
            ...
            <NameMajorBatchContainer>
              <PositionNameContainer>
                <Text
                  size="m"
                  weight="regular"
                  background="linear-gradient(to right,#FFFFFF,#0047FF)"
                >
                  총무부장
                </Text>
                <Text size="xl" weight="bold">
        ...
        <ProfileContainer>
          ...
          <ProfileDescription>
            ...
            <Text size="m" weight="bold">
              {' '}
              KERT의 웹사이트, 서버와 같은 IT 시스템을 관리해요.
            </Text>
          </ProfileDescription>
        </ProfileContainer>
        ...
        <ProfileContainerReverse>
          ...
          <ProfileDescriptionReverse>
            ...
            <Text size="m" weight="bold">
              {' '}
              KERT의 인스타그램,페이스북과 같은 SNS를 관리해요.
              <br />
        ...
        <ProfileContainer>
          ...
          <ProfileDescription>
            <NameMajorBatchContainer>
              ...
              <BatchMajorContainer>
                <Text size="xs" weight="light" color="rgba(255, 255, 255, 0.7)">
                  KERT 23기 글로벌소프트웨어 22학번
                </Text>
              </BatchMajorContainer>
            </NameMajorBatchContainer>
            <Text size="m" weight="bold">
              {' '}
              정기 세미나, 프로젝트 및 스터디를 관리해요.
            </Text>
          </ProfileDescription>
        </ProfileContainer>
      </ProfilesWrapper>
      <StyledButton onClick={handleClick}>역대 임원진 보기</StyledButton>
    </BackFirstStyle>
  );
}
